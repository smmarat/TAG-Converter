...
public class Main {
    ...
    private static final String tt = "text <a href=\"https://www.westernunion.com/ke/en/direct-to-bank-details.html\">link</a> text";
    private static final String tt2 = "<span>text<i>iiii</i>text</span>";
